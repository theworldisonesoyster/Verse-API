...
| ApplyEquippedSidekickCosmetic | Apply the look and customizations of agent's currently equipped Sidekick to this Sidekick NPC. This will fail if the NPC does not use the FortniteSidekick cosmetic look or if the given agent does not have a Sidekick equipped in their locker. |
