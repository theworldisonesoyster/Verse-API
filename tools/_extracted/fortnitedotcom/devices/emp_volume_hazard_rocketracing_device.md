A configurable EMP Volume Hazard that slows Rocket Racing Vehicles.
|  |  |
...
| Disable | Disable this device. While disabled, this has no effect on Rocket Racing Vehicles. |
| Enable | Enable this device. While enabled, this slows Rocket Racing Vehicles. |
