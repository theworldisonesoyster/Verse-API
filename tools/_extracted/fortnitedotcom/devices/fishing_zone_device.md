...
| Reset | Resets the number of available uses for this device back to Uses Allowed. |
| Restock | Returns all caught and removed items to the inventory. This only works when Pool Type is set to Device Inventory. |
