Verse path: /Fortnite.com/Devices Specialized vehicle_spawner_device that allows a Rocket Racing Vehicle to be configured and spawned.
|  |  |
...
| AllowVehicleExitInput | ?logic | Whether players can manually exit the vehicle. If false, the normal exit input will not remove a player from the vehicle. true by default. |
