...
| GetShadowColor | Gets the color of the shadow. |
| GetShadowOffset | Gets the direction the shadow is cast. |
| GetShadowOpacity | Gets the opacity of the shadow. |
...
| SetShadowOffset | Sets the direction the shadow is cast. |
| SetShadowOpacity | Sets the opacity of the shadow. |
