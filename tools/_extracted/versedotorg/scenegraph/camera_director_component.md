...
| AddCamera | Add a camera to the director. The camera with the highest priority will be chosen to be the active camera |
| GetEnterTransition | Get transition to use when entering this camera mode to transition to the specified camera mode |
| GetExitTransition | Get transition to use when exiting this camera mode to transition to the destination camera mode |
