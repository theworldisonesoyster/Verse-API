...
- The structure and content of entities is dynamic and be changed at any time through your experience . Deriving from entity
...
| Name | Description |
| has_tags | An interface representing a mutable collection of tags. |
