...
| Body | ?camera_body | Camera’s body settings. This contains sensor settings, e.g. film or digital camera sensor, shutter speed, etc |
...
| Lens | ?camera_lens | Lens of the camera |
