...
| Disable | Disable the sound component. |
| Enable | Enable the sound component. |
| IsEnabled | Succeeds if the sound component is enabled, fails if it is disabled. |
