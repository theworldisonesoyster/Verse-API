...
| IsActive | Succeeds when this player may be used as a module-scoped var weak_map key. This coincides with the corresponding player having joined the game and not yet left. Using a player as a module-scope var weak_map key when this method fails results in a runtime error. |
